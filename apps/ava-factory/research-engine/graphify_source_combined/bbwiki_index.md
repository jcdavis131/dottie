...
- LLM-wiki output: `docs/llm-wiki/{index.md, tasks-plugin.md, architecture.md, security-model.md, graphify-integration.md, plugins.md, quickstart.md}`
...
## Headlines Expanding Wiki (NEW — 2026-07-17)
- **Daily domain briefs**: finance (holdings-tied META/NVDA/GOOGL/VOO/FIG), world, US, EU, Asia, Texas, Austin, sports, econ/trade, tech_ai
- **Wiki location**: `docs/llm-wiki/headlines/` — see [headlines/index.md](./headlines/index.md) master index
- **Expanding pattern**:
  - Daily: `headlines/{domain}/YYYY-MM-DD.md` (e.g., world/2026-07-17.md)
  - Evolution: `headlines/_by_headline/{domain}_{hash}.md` — same story re-appears appends Evolution Log
  - Graphify source: `ava-research-engine/graphify_source/news_{domain}_{date}_{hash}.md` → graph.json now 1120 nodes / 2295 edges / 102 comms (+436 from baseline 684)
  - Queries verified: `pgraphify query "Texas floods"`, `"Tariffs Fed inflation"`, `"World Cup