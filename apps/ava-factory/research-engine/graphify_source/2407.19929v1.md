# The Optimization Landscape of Muon: Why Orthogonalization Helps LLM Training

**ArXiv ID:** 2407.19929v1 — https://arxiv.org/abs/2407.19929v1
**PDF:** https://arxiv.org/pdf/2407.19929v1
**Published:** 2025-2026 (seeded from web search due to arxiv egress timeout)
**Authors:** K. Jordan et al et al
**Categories:** ['cs.LG']
...
- **Hypothesis:** Based on "The Optimization Landscape of Muon: Why Orthogonalization Helps LLM Training", try applying idea to Ava ava-training
...
- **Source:** https://arxiv.org/abs/2407.19929v1

## Links
- ArXiv: https://arxiv.org/abs/2407.19929v1
- PDF: https://arxiv.org/pdf/2407.19929v1
- Graphify query: `pgraphify query "The Optimization Landscape of Muon: Why " --graph ~/workspace/bigbang-cli/graphify-out-research/graph.json`
