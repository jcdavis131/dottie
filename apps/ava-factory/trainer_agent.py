...
def main():
    ...
    print(
        f"[Trainer] Building DottieStreamingDataset data_root={data_root} branch={args.branch} shuffle_buffer={args.shuffle_buffer} seq_len={args.seq_len} use_chonkie={args.use_chonkie}"
    )
        ...
        for batch in ds.batched(
            ...
            if steps == 20 and args.branch == "base":  # demo checkpoint, real is 736000
                try:
                    ...
                    print(
                        "[Trainer] Saved dottie_stable_736k.pt demo - other agents can start branch training code/math/chat"
                    )
                except:
                    pass
