...
def test_list_layout_multi_source_passes():
    rec = {
        "article_title": "Battle of X",
        "entries": [
            _entry(
                "The battle began in 1900.",
                ["https://a.example/1", "https://b.example/2"],
                [
                    "Author A: the battle began in 1900...",
                    "Author B: in 1900 fighting started...",
                ],
            )
        ],
    }
    ...
    assert (
        "[1] https://a.example/1" in out["text"]
        and "[2] https://b.example/2" in out["text"]
    )
