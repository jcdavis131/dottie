"""Vendored 8x8 monochrome bitmap font (ASCII 0-127).

Source: https://github.com/dhepper/font8x8 (font8x8_basic.h),
author Daniel Hepper, based on work by Marcel Sondaar. License: Public
Domain. Vendored 2026-07-13 so page rendering in ava/pipeline/pxpipe.py
is byte-identical forever -- PIL's default font changes across Pillow
versions, which would break the datagen determinism contract.

Each glyph is 8 row-bytes, LSB = leftmost pixel (per font8x8 layout).
"""
