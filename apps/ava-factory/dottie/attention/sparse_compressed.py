...
10% KV cache vs V3.2 for 1M tokens【600725069786087129†L70-L73】, 284B MoE 13B active 1M context【600725069786087129†L70-L73】
ds4 DwarfStar 4 KV cache on disk streaming【600725069786087129†L73-L76】
"""
...
class SparseCompressedAttention(nn.Module):
    ...
    def forward(self, x, cache_disk=False):
        ...
        if cache_disk:
            # placeholder: in real ds4 KV placed on disk so model with streaming from storage【600725069786087129†L73-L76】
            pass
