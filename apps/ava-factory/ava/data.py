...
from ava.config import TASK_TYPES, AvaConfig
from ava.pipeline.flow import DataState, FlowConfig, StarvationTracker, trainer_data_state
from ava.pipeline.manifest import Manifest, Shard, worker_id
...
class StreamingShardSampler:
    def __init__(self, cfg: AvaConfig, manifest: Manifest, flow: FlowConfig, *,
