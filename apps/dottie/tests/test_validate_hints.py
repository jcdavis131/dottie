...
REAL_CASES = [
    ...
    ("forward produced NaN/Inf — add clamping or an eps term", "STABILITY REPAIR"),
...
NEW_REAL_CASES = [
    ...
    ("syntax", "SyntaxError on line 4: '(' was never closed", "MALFORMED SOURCE"),
    ("syntax", "SyntaxError on line 9: unmatched ']'", "MALFORMED SOURCE"),
    (
        "syntax",
...
def test_assert_catchall_loses_to_specific_classes():
    ...
    detail = "AssertionError: shape '[4, 16, 8, 64]' is invalid for input of size 12288"
