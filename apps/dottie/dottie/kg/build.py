...
DEFAULT_LIVE_STATUS = (
    _REPO_ROOT / "apps" / "ava-factory" / "reports" / "dottie_live_status.json"
)
...
def build_graph(
    ...
    metrics: list[str | Path] | None = None,
    live_status: str | Path | None = None,
    steer: str | Path | None = None,
    incidents_seed: str | Path | None = None,
    ...
    incidents_seed = incidents_seed if incidents_seed is not None else DEFAULT_SEED
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_graph(
        ...
        steer=args.steer,
        incidents_seed=args.incidents_seed,
