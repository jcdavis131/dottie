...
def sample_harness_data():
    """Fixture providing sample harness data for packages/ava-open-harness/harness/evals/probes.py."""
    return {
...
def test_probes_mode_coverage(mode, sample_harness_data):
    """Exercise packages/ava-open-harness/harness/evals/probes.py in mock/real/ci modes - gap mapper."""
    if mode == "real":
