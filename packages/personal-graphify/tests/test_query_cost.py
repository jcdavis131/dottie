...
from personal_graphify.query import format_query_answer, load_graph_json, format_cost_dashboard
...
class TestQueryCostHonesty:
    ...
    def test_dashboard_never_prices_unmeasured_basis(self, tmp_path):
        ...
        cost_path.write_text(json.dumps({
            "nodes": 1, "edges": 0,
            "queries": [
                {"ts": "2026-01-01T00:00:00", "question": "q1", "naive": 100000, "scoped": 100,
                 "saved": 99900, "reduction_x": 1000.0, "mode": "lexical", "basis": "estimated: node-count heuristic"},
                {"ts": "2026-01-01T00:00:01", "question": "q2", "naive": 2000, "scoped": 1000,
                 "saved": 1000, "reduction_x": 2.0, "mode": "lexical", "basis": "measured: sum of indexed file bytes / 4"},
            ],
            "total_saved_tokens": 100900, "total_naive": 102000, "total_scoped": 1100,
        }), encoding="utf-8")
