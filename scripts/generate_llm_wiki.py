...
md_lines.append("")
md_lines.append(f"Total plugins: {len(plugins)} (v0.4.1 includes tasks)")
md_lines.append("")
...
qs.append("bb --help  # 12 plugins: tasks, tools, mcp, ava, agent, system, secrets, auth, family, vector, tennis, doctor")
...
qs.append("## MCP")
qs.append("```bash")
qs.append("bb mcp manifest --json  # 12 bb_* tools")
...
qs.append("# Serve bb as MCP for Claude Desktop:")
qs.append("# bb mcp serve --port 8787")
qs.append("# Claude Desktop config: {\"mcpServers\": {\"bigbang\": {\"url\": \"http://localhost:8787/sse\"}}}")
qs.append("```")
qs.append("")
qs.append("## Ava & Agent")
qs.append("```bash")
...
qs.append("- plugins.md (auto-generated catalog of 12 plugins)")
